// Безопасная конфигурация Firebase для GitHub Pages
// Используйте эту версию только с правильными ограничениями безопасности
...
// ⚠️ ВАЖНО: Настройте правила безопасности в Firebase Console!
// См. файл SECURITY.md для инструкций 